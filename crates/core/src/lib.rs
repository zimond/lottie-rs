...
pub mod prelude {
    ...
    pub use crate::layer::shape::{AnyFill, AnyStroke, PathExt, StyledShape, StyledShapeIterator};
    pub use crate::layer::staged::{RenderableContent, StagedLayer, TextRangeData};
